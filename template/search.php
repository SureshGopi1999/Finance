...
<!-- form data opening-->
   ...
   <button type="submit" class="btn btn-success mb-2">Search</button></center>
           ...
           <center><a href="printreport.php"><button type="btn" name="" class="btn btn-primary mb-2">Print Report</button></a></center>
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      foreach($user as $user){
                       echo "<tr> ";
                       echo "<td>" .$user['id']."</td>";
                       echo "<td>" .$user['vouchertype']."</td>";
                       echo "<td>" .$user['voucherno']."</td>";
                       echo "<td>" .$user['voucherdate']."</td>";
                       echo "<td>" .$user['narration']."</td>";
                       echo "<td>" .$user['debit']."</td>";
                       echo "<td>" .$user['txt_credit']."</td>";
                        }
                        ?>
