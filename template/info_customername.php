...
{
	$sum_amount = 0;
	$sql = "SELECT * FROM tbreceipt_entry WHERE name='$name' AND receipttype ='chittai'";
...
$sum_amount1 = 0;
$sql = "SELECT * FROM tbreceipt_entry WHERE name ='$name' AND receipttype = 'interest'";
$res = mysqli_query($link,$sql);
while($row=mysqli_fetch_array($res)){
...
$sum_amount2 = 0;
$sql1 = "SELECT * FROM tbreceipt_entry WHERE name = '$name' AND receipttype = 'principal'";
